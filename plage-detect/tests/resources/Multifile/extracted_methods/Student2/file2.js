...
function didLanded(w) {
    ...
    let didLandOnBlocks = tetras.doesTetraOverlapsBlocks(tmpTetra, w.blocks);
    return bset.blocksMaxY(w.tetra.blocks) == (consts.boardHeight - 1) || didLandOnBlocks;
}
